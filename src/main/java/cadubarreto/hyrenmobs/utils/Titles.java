...
public class Titles {
	...
	public void send(Player player) {
		if (packetTitle != null) {
			...
			try {
				...
				Object serialized = nmsChatSerializer.getConstructor(new Class[] { String.class })
						.newInstance(new Object[] { ChatColor.translateAlternateColorCodes('&', this.title) });
				packet = packetTitle.getConstructor(new Class[] { packetActions, chatBaseComponent })
						.newInstance(new Object[] { actions[0], serialized });
				sendPacket.invoke(connection, new Object[] { packet });
				if (this.subtitle != "") {
					serialized = nmsChatSerializer.getConstructor(new Class[] { String.class })
							.newInstance(new Object[] { ChatColor.translateAlternateColorCodes('&', this.subtitle) });
					packet = packetTitle.getConstructor(new Class[] { packetActions, chatBaseComponent })
	...
	public void updateTimes(Player player) {
		if (packetTitle != null) {
			try {
				...
				Object packet = packetTitle.getConstructor(
						new Class[] { packetActions, chatBaseComponent, Integer.TYPE, Integer.TYPE, Integer.TYPE })
						.newInstance(new Object[] { actions[2],

								0, Integer.valueOf(this.fadeInTime * (this.ticks ? 1 : 20)),
								Integer.valueOf(this.stayTime * (this.ticks ? 1 : 20)),
								Integer.valueOf(this.fadeOutTime * (this.ticks ? 1 : 20)) });
				if ((this.fadeInTime != -1) && (this.fadeOutTime != -1) && (this.stayTime != -1)) {
					sendPacket.invoke(connection, new Object[] { packet });
	...
	public void clearTitle(Player player) {
		try {
			...
			Method sendPacket = getMethod(connection.getClass(), "sendPacket", new Class[0]);
			Object packet = packetTitle.getConstructor(new Class[] { packetActions, chatBaseComponent })
					.newInstance(new Object[] { actions[3], null });
			sendPacket.invoke(connection, new Object[] { packet });
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void resetTitle(Player player) {
		try {
			...
			Method sendPacket = getMethod(connection.getClass(), "sendPacket", new Class[0]);
			Object packet = packetTitle.getConstructor(new Class[] { packetActions, chatBaseComponent })
					.newInstance(new Object[] { actions[4], null });
			sendPacket.invoke(connection, new Object[] { packet });
		} catch (Exception e) {
			e.printStackTrace();
		}
